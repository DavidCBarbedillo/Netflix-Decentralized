...
export const movies = [
  ...
  },
  {
    ...
    Name: "Hijos Nuestros",
    Description: "Sometimes links can be built from passions. Sometimes those bonds can turn into passions. A fanatic Buenos Aires taxi driver from San Lorenzo crosses paths with a single mother and her son.",
    Genre: "Drama",
    Actors: "Carlos Portaluppi, Ana Katz, Valentín Greco",
    Year: "2015",
    Duration: "87 min",
  },
  {
    ...
    Name: "El Verano que te Vimos",
    Description: "After a year without seeing each other, a group of friends gets together to spend the New Year's in the countryside. During the next days, unsolved problems and tensions from the past will surface that need to be faced sooner or later.",
    Genre: "Drama",
    Actors: "Ary Aguiló, Santiago Luna, Camila Murias",
    Year: "2021",
    Duration: "80 min",
  },
  {
  ...
  },
  {
    ...
    Scene: guerosescena,
    Logo: guerostext,
    Name: "Un día en la vida de Laía",
    Description: "A day in the life of a Mexico City runner preparing herself for her biggest race. Reminiscing on how it all started by following her true convictions and beliefs she unlocks her full potential while remaining level headed, humble and fun.",
    Genre: "Documentary",
    Actors: "n/a",
    Year: "2011",
    Duration: "n/a",
